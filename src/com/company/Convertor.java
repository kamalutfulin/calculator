...
public class Convertor {
    ...
    public void breakIntoElements(String input) {
        ...
        String b = "";
        String operator = "";
        int currentSimvolPosition = 0; //1е  число означает этап ( их 3 : вычленение 1 числа, оператора, второго числа),
// 2е число означает на какой позиции сейчас в Строке Инпут
